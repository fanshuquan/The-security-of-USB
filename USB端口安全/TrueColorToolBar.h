...
protected:
    ...
    //afx_msg void OnToolbarDropDown(NMTOOLBAR* pnmh, LRESULT* plRes);    // By Gu-YB 27/05/2008
    afx_msg void OnToolbarDropDown(NMHDR* pNMHDR, LRESULT* plRes);        // By Gu-YB    27/05/2008
    //}}AFX_MSG
