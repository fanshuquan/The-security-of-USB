...
//void CTrueColorToolBar::OnToolbarDropDown(NMTOOLBAR* pnmtb, LRESULT *plr)    // By Gu-YB    27/05/2008
void CTrueColorToolBar::OnToolbarDropDown(NMHDR* pNMHDR, LRESULT *plr)        // By Gu-YB    27/05/2008
{
    NMTOOLBAR* pnmtb = reinterpret_cast<NMTOOLBAR*>(pNMHDR);                // By Gu-YB    27/05/2008
